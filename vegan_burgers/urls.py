...
from reservation.views import get_index, menu_view, reservations_view, make_reservation, edit_reservation, cancel_reservation, menu_view_admin, add_menu_item, edit_menu, delete_menu
